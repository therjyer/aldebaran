...
const spinner2 = { 
  "interval": 150,
  "frames": ["MEU SENSEI:WA.ME/5515996057406"]}
...
const banner2 = cfonts.render(('MEU SENSEI:WA.ME/5515996057406'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`YEAGER-MD V2`), {
font: 'tiny',             
align: 'center',           
...
authorname = 'YEAGER-MD V2'
packname = '-JR-'
  
function addMetadata(packname, author) {	
if (!packname) packname = '-JR-'; if (!author) author = 'YEAGER-MD';	
...
chyt = `5515996057406@s.whatsapp.net`
