import { default as got } from 'got/dist/source';
import fetch from 'node-fetch';
import { getBase64 } from "./fetcher";
...
const ss = async(query) => {
    request({
        ...
        if (error) {
            ...
            writeFile("./media/img/screenshot.jpeg", body, "binary", error => {
                console.log(error);
            })
        }
    })
...
const _liriklagu = liriklagu;
export { _liriklagu as liriklagu };
const _quotemaker = quotemaker;
export { _quotemaker as quotemaker };
const _randomNimek = randomNimek;
export { _randomNimek as randomNimek };
const _fb = fb;
export { _fb as fb };
const _emojiStrip = emojiStrip;
export { _emojiStrip as emojiStrip };
const _sleep = sleep;
export { _sleep as sleep };
const _jadwalTv = jadwalTv;
export { _jadwalTv as jadwalTv };
const _ss = ss;
export { _ss as ss };